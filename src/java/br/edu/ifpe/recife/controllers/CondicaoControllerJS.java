 ...
 * @author ALUNO
 */
@WebServlet(name = "CondicaoControllerJS", urlPatterns = {"/CondicaoJS"})
public class CondicaoControllerJS extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (codigo != null) {
            ...
            if(op!=null && op.equals("remover")){
                ...
                response.sendRedirect("CondicaoJS");
            ...
            if (op != null && op.equals("editar")) {
                ...
                String json = "{"
                        + "\"codigo\":"+condicao.getCodigo()+","
                        + "\"nome\":\""+condicao.getNome()+"\","
                        + "\"tipo\":\""+condicao.getTipo()+"\","
                        + "\"dataInicio\":\""+condicao.getDataInicioString()+"\","
                        + "\"observacao\":\""+condicao.getObservacao()+"\""
                        + "}";
        ...
        response.sendRedirect("condicoesJS.jsp");
