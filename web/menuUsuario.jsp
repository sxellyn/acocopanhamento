...
<c:if test="${sessionScope.uLogado eq null}">
...
<header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="indexUsuario.jsp">Home</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="d-flex navbar-nav me-auto mb-2 mb-lg-0 pull-right" style="margin-left: 50%" >
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ${sessionScope.uLogado.nome}
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="perfilUsuario.jsp">perfil</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="pull-right btn btn-outline-success" href="Usuario?op=logout" type="button">logout</a>
                            </li>
                        </ul>
                    </li>
